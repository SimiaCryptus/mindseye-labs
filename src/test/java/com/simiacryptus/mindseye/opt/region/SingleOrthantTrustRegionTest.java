...
class SingleOrthantTrustRegionTest extends MnistTestBase {
  ...
  SingleOrthantTrustRegionTest[] addRefs(
    ...
    if (array == null)
      return null;
    return java.util.Arrays.stream(array).filter((x) -> x != null).map(SingleOrthantTrustRegionTest::addRef)
  ...
  SingleOrthantTrustRegionTest[][] addRefs(
    ...
    if (array == null)
      return null;
    return java.util.Arrays.stream(array).filter((x) -> x != null).map(SingleOrthantTrustRegionTest::addRefs)
        .toArray((x) -> new SingleOrthantTrustRegionTest[x][]);
  }
